...
import com.practicum.playlistmaker.domain.SearchStatus
...
class SearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        historyInteractor = Creator.provideTrackHistoryInteractor(this)
        ...
        historyInteractor.getHistory(object : HistoryInteractor.TrackHistoryConsumer {
            override fun consume(trackHistoryList: List<Track>) {
                ...
                searchHistoryList.addAll(trackHistoryList)
            }
        })
    ...
    override fun onDestroy() {
        super.onDestroy()
        historyInteractor.saveHistory(searchHistoryList)
    }
